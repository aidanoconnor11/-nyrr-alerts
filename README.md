...
The workflow is already set to send from `aidanoconnor274@gmail.com` to the same address. Optionally add a repository variable named `NYRR_EVENT_URLS` containing comma-separated event URLs, for example:
